        ...
        <div class="container">
          <div class="row align-items-center justify-content-center">
            <div class="col-md-7 text-center" data-aos="fade">
              <span class="caption mb-3">Our Church</span>
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-md-5 ml-auto">
            ...
            <h2 class="h2 mb-0">Welcome to  refem </h2>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 mx-auto text-center mb-5 section-heading">
            <h2 class="mb-5">Church Elders</h2>
          </div>
        </div>
        <div class="row">
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-6">
            ...
            <h2 class="text-white">REVIVAL FLAMES EVANGELISTIC MISSIONS</h2>
          </div>
          <div class="col-md-6">
