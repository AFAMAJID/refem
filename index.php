    ...
    <div class="slide-one-item home-slider owl-carousel">
        ...
        <div class="container">
          <div class="row align-items-center justify-content-center">
            <div class="col-md-7 text-center" data-aos="fade">
              <span class="caption mb-3">Upcoming Events</span>
              <h1 class="mb-4">December Worship and Truth Concert</h1>
              <p><a href="#" class="text-white py-3 px-4">Participate</a></p>
            </div>
          </div>
        </div>
      </div>  
      ...
      <div class="site-blocks-cover overlay" style="background-image: url(images/hero_2.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center justify-content-center">
            <div class="col-md-7 text-center" data-aos="fade">
              <span class="caption mb-3">Sunday Service</span>
              <h1 class="mb-4">Seek The Lord While He Will Be Found</h1>
              <p><a href="#" class="text-white py-3 px-4">Join With Us</a></p>
            </div>
          </div>
        </div>
      </div> 
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-md-5 ml-auto">
            ...
            <h2 class="h2 mb-0">God is Love</h2>
