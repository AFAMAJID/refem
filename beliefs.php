...
<html lang="en">
  <head>
    <title> refem  &mdash; REVIVAL FLAMES EVANGELISTIC MISSIONS</title>
    <meta charset="utf-8">
  ...
  <div class="site-wrap">
        ...
        <div class="container">
          <div class="row align-items-center justify-content-center">
            <div class="col-md-7 text-center" data-aos="fade">
              <span class="caption mb-3">Read our beliefs us a Church</span>
              <h1 class="mb-4">Fundamental Beliefs of REFEM</h1>
            </div>
          </div>
        </div>
      </div>  
    ...
    <div class="site-block-half d-block d-lg-flex">
        <div class="image bg-image order-2" style="background-image: url('images/hero_1.jpg');"></div>
        <div class="text">
          <div class="section-heading text-left">
            <h2 class="mb-5">The House of God is the House of Prayer</h2>
      ...
      <div class="site-block-half d-block d-lg-flex">
        <div class="image bg-image" style="background-image: url('images/hero_2.jpg');"></div>
        <div class="text">
          <div class="section-heading text-left">
            <h2 class="mb-5">Reading The Word Of God.</h2>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Distinctio autem dolorem vero asperiores itaque officia, assumenda sapiente iste, labore unde nulla facilis fugiat non iure nobis veritatis! Labore, corporis, velit.</p>
            <p><a href="#" class="text-uppercase">Read More <span class="icon-arrow-right small"></span></a></p>
          </div>
        </div>
      ...
      <div class="site-block-half d-block d-lg-flex">
        ...
        <div class="text">
          <div class="section-heading text-left">
            <h2 class="mb-5">Come, Let Us Worship.</h2>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Distinctio autem dolorem vero asperiores itaque officia, assumenda sapiente iste, labore unde nulla facilis fugiat non iure nobis veritatis! Labore, corporis, velit.</p>
            <p><a href="#" class="text-uppercase">Read More <span class="icon-arrow-right small"></span></a></p>
          </div>
        </div>
